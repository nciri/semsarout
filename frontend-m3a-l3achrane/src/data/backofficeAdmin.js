...
export const BACKOFFICE_NAV = [
  ...
  { id: 'verif', icon: 'shield-check', label: 'Vérifications', title: 'Vérifications d’identité', subtitle: 'File KYC — CIN, statut étudiant, attestation employeur' },
  { id: 'listings', icon: 'building-2', label: 'Annonces', title: 'Modération des annonces', subtitle: 'Contrôle qualité et conformité des logements publiés' },
