...
function BuyerMessages() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="font-display text-2xl font-bold text-gray-900">{t('dashboard:messages.buyer.title')}</h1>
        <p className="text-gray-600">{t('dashboard:messages.buyer.subtitle')}</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="card p-12 text-center">
          ...
          <p className="text-gray-600">{t('dashboard:messages.buyer.empty')}</p>
        </div>
      ) : (
