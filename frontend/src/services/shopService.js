...
export const shopService = {
  ...
  cancelOrder: async (id) => (await api.post(`/backoffice/shop/orders/${id}/cancel`)).data,
  summary: async () => (await api.get('/backoffice/shop/orders/summary')).data,
  teamCarts: async () => (await api.get('/backoffice/shop/carts')).data,
