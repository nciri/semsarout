...
-- owner_id : cloisonne `/my-leads` pour les biens de particuliers (sans agence).
INSERT INTO crm.lead (
    id, name, email, phone, message, notes, source, service, status, lost_reason, lost_at,
    property_id, agency_id, owner_id, assigned_to_id, is_charged, charge_amount, is_read, read_at,
